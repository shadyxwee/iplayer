...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'es_ES': {
      ...
      'show_adult_content': 'Mostrar contenido para adultos',
      'manage_profiles': 'Gestionar perfiles',
      'name_required': 'El nombre es obligatorio',
      'cannot_delete_only_profile': 'No puedes eliminar el único perfil',
      'delete_profile_confirm': '¿Estás seguro de que quieres eliminar el perfil "{name}"?',
      ...
      'm3u_playlist_url': 'URL de lista M3U',
      'enter_url': 'Por favor, introduzca una URL',
      'm3u_valid_saving': 'M3U válida. Guardando...',
      'xtream_config': 'Configuración de Xtream Codes',
      'credentials_verified_saving': 'Credenciales verificadas. Guardando...',
      ...
      'sort_by_rating': 'Ordenar por valoración',
      ...
      'delete_playlist_confirm': '¿Estás seguro de que quieres eliminar "{name}"?',
      'delete_playlist_desc': 'Esta acción eliminará {count} canales asociados.',
      'playlist_deleted': 'Lista eliminada',
      'edit_playlist_option': 'Editar lista',
      'refresh_channels_option': 'Actualizar canales',
      'update_epg_option': 'Actualizar EPG',
      'view_info_option': 'Ver información',
      'delete_playlist_option': 'Eliminar lista',
      'updating_epg': 'Actualizando EPG...',
      'epg_updated_success': 'EPG actualizada: {count} programas',
      'epg_update_failed': 'No se pudo cargar la EPG',
      'epg_update_error': 'Error al actualizar la EPG: {error}',
      'xtream_playlist_updated': 'Lista Xtream actualizada:\n{live} canales en vivo\n{movies} películas\n{series} series',
      'xtream_playlist_added': 'Lista Xtream añadida:\n{live} canales en vivo\n{movies} películas\n{series} series',
      'playlist_updated_msg': 'Lista actualizada: {count} canales{epg}',
      'playlist_added_msg': 'Lista añadida: {count} canales{epg}',
      'updated_at_label': 'Actualizado: {date}',
      'no_playlist': 'Sin lista',
      'manage_playlists': 'Gestionar listas de reproducción',
      'app_inspiration': 'Hecho para usuarios premium por CKGROUP.',
      'version_label': 'Versión: {version}',
      'channels_count_short': '{count} canales',
      'select_channel': 'Seleccionar canal',
      'load_epg': 'Cargar EPG',
      'enter_epg_url': 'Introduzca la URL del archivo EPG (formato XMLTV):',
      'enter_valid_url': 'Por favor introduzca una URL válida',
      'loading_epg': 'Cargando EPG...',
      'epg_loaded_success': 'EPG cargada: {channels} canales, {programs} programas',
      'epg_guide_title': 'Guía de Programación (EPG)',
      'go_to_today': 'Ir a hoy',
      'clear_epg_title': 'Borrar EPG',
      'clear_epg_confirm': '¿Desea eliminar todos los datos de EPG?',
      'no_epg_data': 'Sin datos de EPG',
      'load_epg_desc': 'Cargue un archivo EPG para ver la programación',
      'canal_header': 'Canal',
      'no_programming': 'Sin programación',
      'en_vivo_badge': 'EN VIVO',
      'audio_tracks': 'Pistas de audio',
      'no_audio_tracks': 'No hay pistas de audio disponibles',
      'close_button': 'Cerrar',
      'track_short': 'Pista {number}',
      'disabled': 'Desactivado',
      'subtitle_short': 'Subtítulo {number}',
      'no_subtitles': 'No hay subtítulos disponibles',
      'exit_fullscreen_tooltip': 'Salir de pantalla completa',
      'fullscreen_tooltip': 'Pantalla completa',
      'back_button': 'Atrás',
      'audio_track_note': 'Las pistas de audio se seleccionan automáticamente.',
      'subtitle_note': 'Los subtítulos se mostrarán automáticamente si se incluyen en la emisión.',
      'details_label': 'Detalles',
      'played_label': 'Reproducido',
      'times_label': 'veces',
      'last_time_label': 'Última vez',
      'today': 'Hoy',
      'yesterday': 'Ayer',
      ...
      'sunday_short': 'Dom',
      'min_short': 'min',
      'watch_channel': 'Ver canal',
      'reminders_coming_soon': 'Recordatorios próximamente',
      'failed_to_load_stream': 'Error al cargar la emisión: {error}',
      'tomorrow': 'Mañana',
      'of_preposition': 'de',
      'am': 'AM',
      'pm': 'PM',
      ...
      // Settings
      'video_settings': 'Ajustes de video',
      'select_quality': 'Seleccionar calidad',
      'auto': 'Auto',
      'video_fit': 'Ajuste de video',
      'select_video_fit': 'Seleccionar ajuste',
      'fit': 'Ajustar',
      'fill': 'Llenar',
      'fit_width': 'Ajustar ancho',
      'fit_height': 'Ajustar alto',
      'auto_play_on_select': 'Autoreproducción al seleccionar',
      'default_volume': 'Volumen por defecto',
      'parental_controls': 'Control parental',
      'requires_pin': 'Requiere PIN para activar',
      'data_management': 'Gestión de datos',
      'clear_all_data': 'Borrar todos los datos',
      'clear_data_confirm': 'Esto eliminará todas las listas de reproducción, canales y configuraciones. Esta acción no se puede deshacer.',
      'built_with_flutter': 'Construido con Flutter',
      'powered_by': 'Impulsado por {engines}',
      'enter_pin': 'Introducir PIN',
      'enter_4_digit_pin': 'Introducir PIN de 4 dígitos',
      'incorrect_pin': 'PIN incorrecto',
      'delete_all_confirmation': 'Borrar todo',
      ...
      'add_first_playlist': 'Añada su primera lista de reproducción IPTV\npara empezar a ver contenido',
      'help': 'Ayuda',
      ...
      'no_recent': 'Sin canales recientes',
      ...
      'theme_original_desc': 'Tema moderno azul cian',
      'theme_netflix': 'Netflix Oscuro',
      ...
      // Playlist Dialog
      'add_new_playlist_subtitle': 'Añadir nueva lista de reproducción',
      'modify_playlist_subtitle': 'Modificar datos de la lista',
      'playlist_name_label': 'Nombre de la lista',
      'playlist_name_hint': 'Mi IPTV',
      'playlist_name_validation': 'Introduzca un nombre',
      'playlist_url_label': 'URL de la lista',
      'playlist_url_hint': 'https://example.com/playlist.m3u',
      'playlist_url_validation': 'Introduzca la URL',
      'url_validation_protocol': 'La URL debe empezar por http:// o https://',
      'server_host_label': 'Servidor',
      'server_host_hint': 'http://server.com:8080',
      'server_host_validation': 'Introduzca el servidor',
      'protocol_validation': 'Debe empezar por http:// o https://',
      'username_label': 'Usuario',
      'username_hint': 'miusuario',
      'username_validation': 'Introduzca el usuario',
      'password_label': 'Contraseña',
      'password_hint': 'Su contraseña',
      'password_validation': 'Introduzca la contraseña',
      ...
      'xtream_url_desc': 'El sistema detecta automáticamente las credenciales y carga la EPG',
      'epg': 'EPG:',
      'epg_desc': 'La guía de programación se carga automáticamente si está disponible',
      'update': 'Actualización:',
      'update_desc': 'Use el botón de actualizar para recargar canales',
      'understood': 'Entendido',

      // Loading Dialog
      'loading_playlist': 'Cargando lista de reproducción...',
      'updating_playlist': 'Actualizando lista de reproducción...',
  ...
  String translate(String key) {
    // Support dynamic localization using the current locale
    String languageCode = '${locale.languageCode}_${locale.countryCode ?? ''}';

    // If exact locale (e.g. en_US) is not found, fallback to language code (e.g. en)
    String? value = _localizedValues[languageCode]?[key];
    if (value == null) {
      final matchingKey = _localizedValues.keys.firstWhere(
        (k) => k.startsWith(locale.languageCode),
        orElse: () => 'en_US',
      );
      value = _localizedValues[matchingKey]?[key];
    }
