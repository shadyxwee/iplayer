...
const ProfileSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'showAdultContent': PropertySchema(
      id: 4,
      name: r'showAdultContent',
      type: IsarType.bool,
    ),
...
int _profileEstimateSize(
  ...
  bytesCount += 3 + object.videoQuality.length * 3;
  return bytesCount;
}
...
void _profileSerialize(
  ...
  writer.writeBool(offsets[4], object.showAdultContent);
  writer.writeString(offsets[5], object.videoQuality);
}
...
Profile _profileDeserialize(
  ...
  object.showAdultContent = reader.readBool(offsets[4]);
  object.videoQuality = reader.readString(offsets[5]);
  return object;
}
...
extension ProfileQueryFilter
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> showAdultContentEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'showAdultContent',
        value: value,
      ));
    });
  }

  QueryBuilder<Profile, Profile, QAfterFilterCondition> videoQualityEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> videoQualityGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> videoQualityLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> videoQualityBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> videoQualityStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> videoQualityEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> videoQualityContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> videoQualityMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> videoQualityIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'videoQuality',
        value: '',
...
extension ProfileQuerySortBy on QueryBuilder<Profile, Profile, QSortBy> {
  ...
  QueryBuilder<Profile, Profile, QAfterSortBy> sortByShowAdultContent() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'showAdultContent', Sort.asc);
    });
  }

  QueryBuilder<Profile, Profile, QAfterSortBy> sortByShowAdultContentDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'showAdultContent', Sort.desc);
    });
  }

  QueryBuilder<Profile, Profile, QAfterSortBy> sortByVideoQuality() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'videoQuality', Sort.asc);
    });
  }

  QueryBuilder<Profile, Profile, QAfterSortBy> sortByVideoQualityDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProfileQuerySortThenBy
  ...
  QueryBuilder<Profile, Profile, QAfterSortBy> thenByShowAdultContent() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'showAdultContent', Sort.asc);
    });
  }

  QueryBuilder<Profile, Profile, QAfterSortBy> thenByShowAdultContentDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'showAdultContent', Sort.desc);
    });
  }

  QueryBuilder<Profile, Profile, QAfterSortBy> thenByVideoQuality() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'videoQuality', Sort.asc);
    });
  }

  QueryBuilder<Profile, Profile, QAfterSortBy> thenByVideoQualityDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'videoQuality', Sort.desc);
    });
  }
...
extension ProfileQueryWhereDistinct
  ...
  QueryBuilder<Profile, Profile, QDistinct> distinctByShowAdultContent() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'showAdultContent');
    });
  }

  QueryBuilder<Profile, Profile, QDistinct> distinctByVideoQuality(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ProfileQueryProperty
  ...
  QueryBuilder<Profile, bool, QQueryOperations> showAdultContentProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'showAdultContent');
    });
  }

  QueryBuilder<Profile, String, QQueryOperations> videoQualityProperty() {
    return QueryBuilder.apply(this, (query) {
